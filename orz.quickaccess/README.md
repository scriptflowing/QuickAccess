...
<root>
  ...
  ├── Editor
  │   ├── Undefined.OrzQuickaccess.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.OrzQuickaccess.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.OrzQuickaccess.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.OrzQuickaccess.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.OrzQuickaccess`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package orz.quickaccess Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.OrzQuickaccess.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.OrzQuickaccess.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.OrzQuickaccess.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.OrzQuickaccess.Tests.asmdef`
...
Use the `Documentations~/orz.quickaccess.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
